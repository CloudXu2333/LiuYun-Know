      ...
      <nav className="h-14 md:h-16 bg-white shadow-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-3 md:px-4 h-full flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-[#E8F0FE] rounded-lg flex items-center justify-center text-xl md:text-2xl text-[#1A73E8]">
              <Home size={20} />
            </div>
            <span className="text-lg md:text-xl font-medium text-gray-700">历史项目</span>
          </div>
              ...
              <div className="flex items-center gap-3 pb-2 border-b border-gray-200">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 text-[#1A73E8] border-gray-300 rounded focus:ring-blue-500"
                  />
