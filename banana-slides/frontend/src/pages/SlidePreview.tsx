      ...
      <header className="h-14 md:h-16 bg-white shadow-sm border-b border-gray-200 flex items-center justify-between px-3 md:px-6 flex-shrink-0">
        <div className="flex items-center gap-2 md:gap-4 min-w-0 flex-1">
          ...
          <div className="flex items-center gap-1.5 md:gap-2 min-w-0">
            <span className="text-xl md:text-2xl text-[#4285F4]"><Sparkles size={24} /></span>
            <span className="text-base md:text-xl font-normal text-gray-600 truncate">AI Slides</span>
          </div>
                  ...
                  <div className="md:hidden relative">
                    <button
                      ...
                      className={`w-20 h-14 rounded border-2 transition-all ${selectedIndex === index
                          ...
                          : 'border-gray-200'
                        } ${isMultiSelectMode && page.id && selectedPageIds.has(page.id) ? 'ring-2 ring-blue-400' : ''}`}
                    >
                    ...
                    {isMultiSelectMode && page.id && page.generated_image_path && (
                      <button
                        ...
                        className={`absolute top-2 left-2 z-10 w-6 h-6 rounded flex items-center justify-center transition-all ${selectedPageIds.has(page.id)
                            ...
                            : 'bg-white/90 border-2 border-gray-300 hover:border-blue-400'
                          }`}
                      >
                          ...
                          <div className="absolute right-0 bottom-full mb-2 w-56 md:w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-20 max-h-96 overflow-y-auto">
                            {imageVersions.map((version) => (
                              <button
                                ...
                                className={`w-full px-3 md:px-4 py-2 text-left hover:bg-gray-50 transition-colors flex items-center justify-between text-xs md:text-sm ${version.is_current ? 'bg-blue-50' : ''
                                  }`}
                              >
            ...
            {imageUrl && (
              <>
                ...
                <button
                  ...
                  className="absolute top-2 left-2 z-10 px-2 py-1 rounded bg-white/80 text-[10px] text-gray-700 hover:bg-blue-50 shadow-sm flex items-center gap-1"
                >
                  <Sparkles size={12} />
                ...
                {selectionRect && (
                  <div
                    className="absolute border-2 border-[#1A73E8] bg-blue-400/10 pointer-events-none"
                    style={{
          ...
          <div className="bg-gray-50 rounded-lg border border-gray-200 p-4 space-y-4">
                    ...
                    {descImageUrls.map((url, idx) => (
                      <div key={idx} className="relative group">
                        ...
                        {selectedContextImages.descImageUrls.includes(url) && (
                          <div className="absolute inset-0 bg-blue-500/20 border-2 border-[#1A73E8] rounded flex items-center justify-center">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <label className="w-20 h-20 border-2 border-dashed border-gray-300 rounded flex flex-col items-center justify-center cursor-pointer hover:border-[#1A73E8] transition-colors">
