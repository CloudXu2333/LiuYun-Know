...
export const OutlineEditor: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="flex items-center justify-between gap-2 md:gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
            ...
            <div className="flex items-center gap-1.5 md:gap-2">
              <span className="text-xl md:text-2xl text-[#4285F4]"><Sparkle size={24} /></span>
              <span className="text-base md:text-xl font-normal text-gray-600">AI Slides</span>
            </div>
      ...
      {/* 上下文栏 */}
      <div className="bg-gray-50 border-b border-gray-200 px-3 md:px-6 py-2 md:py-3 max-h-32 overflow-y-auto flex-shrink-0">
                ...
                <ul className="space-y-1.5 md:space-y-2">
                  {selectedPage.outline_content.points.map((point, idx) => (
                    <li key={idx} className="flex items-start text-sm md:text-base text-gray-700">
                      <span className="mr-2 text-[#4285F4] flex-shrink-0">•</span>
                      <span>{point}</span>
                    </li>
                  ))}
                </ul>
                ...
                <ul className="space-y-1">
                  {selectedPage.outline_content.points.map((point, idx) => (
                    <li key={idx} className="flex items-start text-xs text-gray-700">
                      <span className="mr-1.5 text-[#4285F4] flex-shrink-0">•</span>
                      <span>{point}</span>
                    </li>
                  ))}
                </ul>
